...
function testimonialSlider(){
    ...
    if(carouselOne){
        carouselOne.addEventListener('slid.bs.carousel', function () {
            ...
            activeItem.getAttribute("data-ja-testimonial-img");
        } )
    }
}
testimonialSlider();
...
function coursePreviewVideo(){
    ...
    if(coursePreviewModal){ /*if the element exist*/
...
function headerMenu(){
    ...
    //  close the menu by clickng outside of it
...
function themeGlassEffect(){
    ...
    if(localStorage.getItem("glass-effect") !== nul){
        glass();
    }
